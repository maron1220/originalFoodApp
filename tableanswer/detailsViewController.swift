...
//        foodImageView.layer.masksToBounds = true
    ...
    //猫
    var explainCat2Array:[[String]] = [/*腎臓*/["リンの含有量を制限","リンの含有量を制限","リンの含有量を制限","ツナとチキンの二種類の味","リンの含有量を制限"],/*膀胱･尿路*/["シュウ酸カルシウム結石症に適応","シュウ酸カルシウム結石症に適応","シュウ酸カルシウム結石症に適応","シュウ酸カルシウム結石症に適応","シュウ酸カルシウム結石症に適応","シュウ酸カルシウム結石症に適応","シュウ酸カルシウム結石症に適応","猫の精神的な健康に配慮"],/*皮膚*/["消化器疾患の猫に給与","消化器疾患の猫に給与","消化器疾患の猫に給与","高消化性の加水分解タンパクを使用"],/*消化器*/["少ない食事量でも必要なカロリーを摂取可能","高消化性の原材料を使用","優れた消化性"],/*体重管理*/["食物繊維を増量","骨と関節の健康維持","野菜由来の食物繊維を含有","低脂肪","低脂肪","高タンパク質"],/*糖尿病*/["肝リピドーシスの猫にも適応","低炭水化物"]]
