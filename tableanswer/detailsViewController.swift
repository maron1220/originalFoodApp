...
//        foodImageView.layer.masksToBounds = true
    ...
    //ラベル1の説明
    //犬
    var explain1Array:[[String]] = [/*腎臓*/["慢性腎臓病の管理","慢性腎臓病の管理","慢性腎臓病の管理","慢性腎臓病の管理","初期の心臓疾患の管理","初期の心臓疾患の管理","慢性腎臓病の管理","慢性腎臓病の管理","慢性腎臓病の管理"],/*膀胱･尿路*/["ストラバイト結石症に適応","ストラバイト結石症に適応","ストラバイト結石症に適応","ストラバイト結石症に適応","ストラバイト結石の溶解･管理","非ストラバイト性の尿石形成を抑制","ストラバイト結石の溶解･管理","ストラバイト尿石症に対応","ストラバイト尿石症に対応"],/*皮膚*/["皮膚疾患の犬に給与","皮膚疾患の犬に給与","皮膚疾患の犬に給与","皮膚疾患の犬に給与","皮膚疾患の犬に給与","皮膚疾患の犬に給与","皮膚疾患の犬に給与","皮膚疾患の犬に給与","スキンバリアを維持","新奇動物性たんぱく質を使用","新奇動物性たんぱく質を使用","食物アレルギーに配慮","食物アレルギーに配慮","食物アレルギーに対応"],["犬皮膚1","皮膚2","皮膚3","皮膚4","皮膚5","皮膚6","皮膚7"]]
    
    //猫
    var explainCat1Array:[[String]] = [/*腎臓*/["慢性腎臓病の管理","慢性腎臓病の管理","慢性腎臓病の管理","慢性腎臓病の管理","慢性腎臓病の管理","慢性腎臓病の管理"],/*膀胱･尿路*/["ストラバイト結石症に適応","ストラバイト結石症に適応","ストラバイト結石症に適応","ストラバイト結石症に適応","ストラバイト結石症に適応","ストラバイト結石症に適応","ストラバイト結石症に適応","特発性膀胱炎に適応"],/*皮膚*/["皮膚疾患の猫に給与","皮膚疾患の猫に給与","皮膚疾患の猫に給与","食物アレルギーに配慮"],["猫皮膚1","皮膚2","皮膚3","皮膚4","皮膚5","皮膚6","皮膚7"]]
    
    //ラベル2の説明
    //犬
    var explain2Array:[[String]] = [/*腎臓*/["リンの含有量を制限","リンの含有量を制限","食物アレルギーにも配慮","blank","関節疾患の管理","ナトリウムを制限","blank","リンの調整と低ナトリウム","リンの含有量を制限"],/*膀胱･尿路*/["シュウ酸カルシウム結石症に適応","シュウ酸カルシウム結石症に適応","シュウ酸カルシウム結石症に適応","シュウ酸カルシウム結石症に適応","シュウ酸カルシウム結石形成を抑制","ナトリウム･カルシウムを制限","シュウ酸カルシウム結石形成を抑制","シュウ酸カルシウム尿石症に対応","リンを制限"],/*皮膚*/["高消化性の原材料","消化器疾患の犬に給与","消化器疾患の犬に給与","消化器疾患の犬に給与","消化器疾患の犬に給与","消化器疾患の犬に給与","消化器疾患の犬に給与","消化器疾患の犬に給与","自然由来のポリフェノール､卵を配合","タンパク源(サーモンとポテト)､炭水化物源(ポテト)","タンパク源(ダックとポテト)､炭水化物源(ポテト)","加水分解タンパクを使用","加水分解タンパクを使用","タンパク源(ポテト)"],["犬皮膚1","皮膚2","皮膚3","皮膚4","皮膚5","皮膚6","皮膚7"]]
    
    //猫
    var explainCat2Array:[[String]] = [/*腎臓*/["リンの含有量を制限","リンの含有量を制限","リンの含有量を制限","blank","ツナとチキンの二種類の味","リンの含有量を制限"],/*膀胱･尿路*/["シュウ酸カルシウム結石症に適応","シュウ酸カルシウム結石症に適応","シュウ酸カルシウム結石症に適応","シュウ酸カルシウム結石症に適応","シュウ酸カルシウム結石症に適応","シュウ酸カルシウム結石症に適応","シュウ酸カルシウム結石症に適応","猫の精神的な健康に配慮"],/*皮膚*/["消化器疾患の猫に給与","消化器疾患の猫に給与","消化器疾患の猫に給与","高消化性の加水分解タンパクを使用"],["猫皮膚1","皮膚2","皮膚3","皮膚4","皮膚5","皮膚6","皮膚7"]]
    
    //ラベル3の説明
    var explain3Array:[[String]] = [/*腎臓*/["食欲刺激","食欲刺激","大豆タンパクを使用","blank","腎臓病にも適応","腎臓病にも適応","blank","筋肉の生成をサポート","国産フード"],/*膀胱･尿路*/["ミネラル成分を調整","体重過多に配慮","食物アレルギーに配慮","減量を必要とする犬に適応","ミネラル･尿pHに配慮","ミネラルを調整","低カロリー","食べやすい小粒サイズ","マグネシウムを制限"],/*皮膚*/["ω3脂肪酸を含有","加水分解タンパクを使用","体重過多に配慮","減量が必要な犬に給与","炭水化物源としてコーンスターチを使用","タンパク源(ダック)､炭水化物源(タピオカ)","タンパク源(フィッシュとポテト)､炭水化物源(ポテト)","タンパク源(カンガルーとオーツ)､炭水化物源(オーツ)","ω-3&6脂肪酸を配合","ω-3脂肪酸を配合","ω-3脂肪酸を配合","炭水化物源(ポテト)","炭水化物源(コーンスターチ)","合成酸化剤不使用"],["犬皮膚1","皮膚2","皮膚3","皮膚4","皮膚5","皮膚6","皮膚7"]]
    
    //猫
    var explainCat3Array:[[String]] = [/*腎臓*/["食欲刺激","高エネルギー","食欲刺激","blank","おいしさを追求","国産フード"],/*膀胱･尿路*/["結石予防効果が高い","ミネラル成分を調整","ミネラル成分を調整","食欲をそそる独自の香りを調整","体重過多に配慮","減量を必要とする猫に適応","特発性膀胱炎に適応","減量を必要とする猫に適応"],/*皮膚*/["加水分解タンパクを使用","タンパク源(ダック)､炭水化物源(ライス)","炭水化物源(コーンスターチ)","炭水化物源(米)"],["猫皮膚1","皮膚2","皮膚3","皮膚4","皮膚5","皮膚6","皮膚7"]]
