...
//
    ...
    //猫
    var catfoodlistArray:[[String]] = [/*腎臓*/["腎臓サポート","腎臓サポート セレクション","腎臓サポート スペシャル","k/d(ツナorチキン)","キドニーケア"],/*膀胱･尿路*/["pHコントロール0","pHコントロール1","pHコントロール2","pHコントロール オルファクトリー","pHコントロール ライト","pHコントロール+満腹感サポート","pHコントロール+CLT","満腹感サポート+CLT","c/d","メタボリックス+ユリナリー","メタボリックス+ユリナリー+コンフォート","ストルバイトケア(スターター)","s/d","ストラバイトケア"],/*皮膚*/["低分子プロテイン","セレクトプロテイン(ダック&ライス)","アミノペプチドフォーミュラ","z/d(低アレルゲン)"],/*消化器*/["消化器サポート","消化器サポート(可溶性繊維)","i/d"],/*体重管理*/["満腹感サポート","減量サポート","メタボリックス","r/d","w/d","m/d"],["糖コントロール","m/d"]]
